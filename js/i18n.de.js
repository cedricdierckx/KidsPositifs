...
Object.assign(I18N.de, {
  ...
  "fam.inv_titre": "🔗 Einladungen (für ein weiteres Elternteil)",
  ...
  "mission.aider_spontane": "Helfen, ohne gefragt zu werden",
  "mission.desaccord": "Einen Streit im Gespräch klären",
  "mission.lave_vaisselle": "Geschirrspüler ein- oder ausräumen",
  "mission.petit_dej": "Sein Frühstück selbst machen",
  "mission.lire_seul": "Eine Weile allein lesen",
  "mission.reveil_seul": "Allein aufstehen",
  "mission.aider_devoirs": "Einem Jüngeren bei den Hausaufgaben helfen",
  "mission.repas_simple": "Eine einfache Mahlzeit kochen",
  "mission.organiser": "Einen Familienmoment organisieren",
  "mission.veille": "Geräte aus dem Standby nehmen",
  "mission.saison": "Ein Obst oder Gemüse der Saison wählen",
  "mission.reparer_objet": "Reparieren statt ersetzen",
  "mission.seconde_main": "Second-Hand wählen",
  ...
  "papier.humeur": "Habe ich mein Bestes gegeben? (kreise 😄 😐 😠 ein)",
  "papier.humeur_jour": "Ich habe mein Bestes gegeben",
  ...
  "papier.mode_photo": "Foto (automatisch)",
  "papier.mode_fichier": "Scan (Datei oder PDF)",
  "papier.mode_detaille": "Manuell (Kästchen für Kästchen)",
  "papier.mode_express": "Schnell (nur Summen)",
  ...
  "timer.mode_permanent_note": "Die Zähler werden automatisch 6 Std. nachdem das erste Kind zu spielen begonnen hat zurückgesetzt. Die Eltern müssen nichts entsperren: einfach auswählen, wer wieder anfängt, ohne PIN.",
  "timer.mode_off": "🚫 Timer deaktiviert (die App bleibt ohne Zeitlimit verfügbar)",
  "timer.enregistrer": "✅ Speichern",
  "timer.permanent_active": "Dauerhafte Sperre aktiviert 🔁",
  "timer.off_active": "Timer deaktiviert",
  ...
  "verrouPerm.titre": "Zeit ist um!",
  "verrouPerm.texte": "Zeit für eine Pause 😊 Neue Zeit kommt automatisch, keine PIN nötig.",
  "verrouPerm.parents": "Elternbereich",
  "verrouPerm.attente_h": "Neue Zeit in {h} Std. {m} Min.",
  "verrouPerm.attente_m": "Neue Zeit in {m} Min.",
  ...
  "choixDemarrage.titre": "Wer fängt an?",
  "choixDemarrage.texte": "Tippe auf deinen Namen, um deine Zeit zu starten.",
  ...
  "eval.enf_bien": "Ja, wirklich!",
  "eval.enf_moyen": "Ein bisschen",
  "eval.enf_mauvais": "Nicht wirklich",
