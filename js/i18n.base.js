...
const I18N = {
  fr: {
    ...
    "papier.humeur": "Ai-je fait de mon mieux ? (entoure 😄 😐 😠)",
    "papier.humeur_jour": "J'ai fait de mon mieux",
    ...
    "papier.mode_photo": "Photo (automatique)",
    "papier.mode_fichier": "Scan (fichier ou PDF)",
    "papier.mode_detaille": "Manuel (case par case)",
    ...
    "timer.mode_permanent_note": "Les compteurs se réinitialisent automatiquement 6 h après que le premier enfant a commencé à jouer. Le parent n'a rien à déverrouiller : il suffit ensuite de choisir qui recommence, sans code PIN.",
    "timer.mode_off": "🚫 Minuteur désactivé (l'app reste disponible sans limite de temps)",
    "timer.enregistrer": "✅ Enregistrer",
    "timer.permanent_active": "Verrouillage permanent activé 🔁",
    "timer.off_active": "Minuteur désactivé",
    ...
    "choixDemarrage.titre": "Qui commence ?",
    "choixDemarrage.texte": "Touche ton prénom pour lancer ton temps.",
    ...
    "eval.enf_bien": "Oui, vraiment !",
    "eval.enf_moyen": "Un peu",
    "eval.enf_mauvais": "Pas vraiment",
