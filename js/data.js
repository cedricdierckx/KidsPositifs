...
const MISSIONS = [
  ...
  { id: "dents",         cat: "famille", emoji: "🪥", emojiRepli: "🦷", titre: "Se brosser les dents",       ageMin: 2, points: 1, type: "quotidien" },
...
const TIERS_ECO = [
  ...
  },
  {
    ...
    especes: [
      ...
      { id: "autruche",  emoji: "🦤", emojiRepli: "🐦",  nom: "Autruche",   cout: 40,  prereq: { herbe: 3, ble: 1 } },
...
/* ---- Blagues & devinettes, par langue ---------------------------------
 * Règle de sélection (chantier 7) : uniquement des devinettes traditionnelles
 * et anonymes — celles qu'on se raconte dans les cours de récréation depuis
 * toujours, sans auteur identifiable. Écartées : toute blague attribuable à
 * un humoriste ou à une source contemporaine, toute marque déposée, tout
 * personnage sous droits, et tout ce qui n'a pas sa place chez des 3-12 ans
 * (violence, sous-entendus, moqueries).
 * Chaque langue a SES blagues : une traduction littérale tue le jeu de mots
 * (« brown and sticky : a stick » ne veut plus rien dire en néerlandais).
 * Le banc d'essai vérifie ces règles ; ce qu'il ne peut pas vérifier, c'est
 * le goût — d'où la relecture humaine avant d'armer app_config.blagues_actives. */
const BLAGUES_DEFAUT = {
  ...
  { q: "Quel est le comble pour un boulanger ?", r: "Être dans le pétrin ! 🥖" },
  ...
  { q: "Qu'est-ce qui a des dents mais ne mord jamais ?", r: "Un peigne ! 💇" },
  { q: "Qu'est-ce qui a des touches mais n'ouvre aucune porte ?", r: "Un piano ! 🎹" },
  { q: "Plus il sèche, plus il est mouillé. Qu'est-ce que c'est ?", r: "Une serviette ! 🛁" },
  { q: "Quel mois de l'année compte 28 jours ?", r: "Tous ! 📅" },
  { q: "Qu'est-ce qui a un chapeau sans tête et un pied sans chaussure ?", r: "Un champignon ! 🍄" },
  { q: "Qu'est-ce qui monte et ne redescend jamais ?", r: "Ton âge ! 🎂" },
  { q: "Qu'y a-t-il entre le ciel et la terre ?", r: "Le mot « et » ! ☁️" },
  { q: "Que fait-on avec un éléphant tout bleu ?", r: "On le console jusqu'à ce qu'il redevienne joyeux ! 🐘💙" }
  ],
  en: [
  ...
  { q: "What has hands but cannot clap?", r: "A clock! 🕒" },
  { q: "What has teeth but cannot bite?", r: "A comb! 💇" },
  { q: "What has keys but opens no doors?", r: "A piano! 🎹" },
  { q: "What gets wetter the more it dries?", r: "A towel! 🛁" },
  { q: "Which month has 28 days?", r: "All of them! 📅" },
  { q: "How do you put an elephant in the fridge?", r: "Open the door, in goes the elephant, close the door! 🐘" },
  { q: "What is green and flies?", r: "A frog in an aeroplane! 🐸✈️" }
  ],
  nl: [
  ...
  { q: "Waarom springt de kangoeroe niet graag in de regen?", r: "Omdat haar jong dan binnen blijft! 🦘" },
  { q: "Wat zit er tussen hemel en aarde?", r: "Het woordje « en »! ☁️" },
  { q: "Welke maand heeft 28 dagen?", r: "Allemaal! 📅" },
  { q: "Wat heeft tanden maar kan niet bijten?", r: "Een kam! 💇" },
  { q: "Wat heeft toetsen maar opent geen enkele deur?", r: "Een piano! 🎹" },
  { q: "Hoe meer het droogt, hoe natter het wordt. Wat is het?", r: "Een handdoek! 🛁" },
  { q: "Ik heb een hoed maar geen hoofd, een voet maar geen schoen. Wat ben ik?", r: "Een paddenstoel! 🍄" },
  { q: "Ik heb een oog maar kan niet zien. Wat ben ik?", r: "Een naald! 🧵" },
  { q: "Wat is het verschil tussen een brievenbus en een olifant?", r: "Weet je dat niet? Dan vraag ik jou nooit een brief te posten! 🐘✉️" },
  { q: "Hoe krijg je een olifant in de koelkast?", r: "Deur open, olifant erin, deur dicht! 🐘" },
  { q: "Wat doe je met een blauwe olifant?", r: "Troosten tot hij weer vrolijk is! 🐘💙" },
  { q: "Waarom nemen olifanten nooit een koffer mee?", r: "Ze hebben hun slurf altijd al bij zich! 🐘" },
  { q: "Waarom hebben giraffen zo'n lange nek?", r: "Omdat hun hoofd zo ver van hun lijf zit! 🦒" },
  { q: "Wat zegt de ene kaars tegen de andere?", r: "« Ga jij vanavond ook uit? » 🕯️" },
  { q: "Wat is groen en vliegt?", r: "Een kikker in een vliegtuig! 🐸✈️" },
  { q: "Welke vis kan niet zwemmen?", r: "Een stokvis! 🐟" },
  { q: "Wat is oranje en gaat over de berg?", r: "Een wandarijn! 🍊" },
  { q: "Wat ligt op het strand en mompelt?", r: "Een mompelschelp! 🐚" },
  { q: "Wat is wit en stoort bij het ontbijt?", r: "Een lawine! 🏔️" },
  { q: "Wie zit er in de boom en roept « aha »?", r: "Een oehoe met een spraakfoutje! 🦉" },
  { q: "Welk dier kan het hoogst springen?", r: "Alle dieren — een berg kan niet springen! ⛰️" }
  ],
  de: [
  ...
  { q: "Was steht zwischen Himmel und Erde?", r: "Das Wörtchen « und »! ☁️" },
  { q: "Welcher Monat hat 28 Tage?", r: "Alle! 📅" },
  { q: "Was hat Zähne, kann aber nicht beißen?", r: "Ein Kamm! 💇" },
  { q: "Was hat Tasten, öffnet aber keine Tür?", r: "Ein Klavier! 🎹" },
  { q: "Je mehr es trocknet, desto nasser wird es. Was ist das?", r: "Ein Handtuch! 🛁" },
  { q: "Was hat einen Hut ohne Kopf und einen Fuß ohne Schuh?", r: "Ein Pilz! 🍄" },
  { q: "Was ist der Unterschied zwischen einem Briefkasten und einem Elefanten?", r: "Weißt du das nicht? Dann schicke ich dich nie einen Brief einwerfen! 🐘✉️" },
  { q: "Wie bringt man einen Elefanten in den Kühlschrank?", r: "Tür auf, Elefant rein, Tür zu! 🐘" },
  { q: "Was macht man mit einem blauen Elefanten?", r: "Man tröstet ihn, bis er wieder fröhlich ist! 🐘💙" },
  { q: "Warum nehmen Elefanten nie einen Koffer mit?", r: "Sie haben ihren Rüssel immer schon dabei! 🐘" },
  { q: "Warum haben Giraffen so lange Hälse?", r: "Weil ihr Kopf so weit weg vom Körper ist! 🦒" },
  { q: "Was sagt eine Kerze zur anderen?", r: "« Gehst du heute Abend auch aus? » 🕯️" },
  { q: "Was ist grün und fliegt?", r: "Ein Frosch im Flugzeug! 🐸✈️" },
  { q: "Was ist gelb und schießt?", r: "Eine Banone! 🍌" },
  { q: "Was ist orange und wandert über den Berg?", r: "Eine Wanderine! 🍊" },
  { q: "Was liegt am Strand und spricht undeutlich?", r: "Eine Nuschel! 🐚" },
  { q: "Was ist weiß und stört beim Frühstück?", r: "Eine Lawine! 🏔️" },
  { q: "Wer sitzt im Baum und ruft « aha »?", r: "Ein Uhu mit Sprachfehler! 🦉" }
  ]
};
