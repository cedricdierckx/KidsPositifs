...
Object.assign(I18N.fr, {
  ...
  "rituel.intro": "FamiTeam ne vous enverra jamais de notification. Mais vous pouvez déposer un rendez-vous de cinq minutes dans <strong>votre propre agenda</strong> : c'est lui qui vous préviendra, à l'heure que vous choisissez.",
  ...
  "rituel.conseil": "Une demi-heure avant le coucher le plus tôt, soit {h} chez vous : tout le monde est encore debout.",
  ...
  "rituel.note": "Le fichier va dans votre agenda, pas chez nous : nous ne savons pas si vous l'avez ajouté. Pour arrêter, supprimez l'événement — vous n'avez rien à nous demander.",
...
Object.assign(I18N.en, {
  ...
  "rituel.intro": "FamiTeam will never send you a notification. But you can drop a five-minute appointment into <strong>your own calendar</strong>: it is your calendar that will remind you, at the time you choose.",
  ...
  "rituel.conseil": "Half an hour before the earliest bedtime, which is {h} in your family: everyone is still up.",
  ...
  "rituel.note": "The file goes into your calendar, not to us: we do not know whether you added it. To stop, delete the event — you do not have to ask us anything.",
...
Object.assign(I18N.nl, {
  ...
  "rituel.intro": "FamiTeam stuurt u nooit een melding. Maar u kunt een afspraak van vijf minuten in <strong>uw eigen agenda</strong> zetten: die verwittigt u, op het uur dat u kiest.",
  ...
  "rituel.conseil": "Een half uur voor de vroegste bedtijd, dus {h} bij u: iedereen is dan nog op.",
  ...
  "rituel.note": "Het bestand gaat naar uw agenda, niet naar ons: wij weten niet of u het hebt toegevoegd. Om te stoppen verwijdert u het item — u hoeft ons niets te vragen.",
...
Object.assign(I18N.de, {
  ...
  "rituel.intro": "FamiTeam schickt Ihnen niemals eine Benachrichtigung. Aber Sie können einen Fünf-Minuten-Termin in <strong>Ihren eigenen Kalender</strong> legen: dieser erinnert Sie, zur Uhrzeit Ihrer Wahl.",
  ...
  "rituel.conseil": "Eine halbe Stunde vor der frühesten Schlafenszeit, also {h} bei Ihnen: da sind alle noch wach.",
  ...
  "rituel.note": "Die Datei geht in Ihren Kalender, nicht zu uns: wir wissen nicht, ob Sie sie hinzugefügt haben. Zum Beenden löschen Sie den Termin — Sie müssen uns nichts mitteilen.",
