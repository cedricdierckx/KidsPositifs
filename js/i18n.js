...
Object.assign(I18N.fr, {
  ...
  "admin.mailtest_note": "Envoie un e-mail de réinitialisation (même chemin que les e-mails de confirmation / mot de passe oublié) pour vérifier que le SMTP de Supabase fonctionne. N'arrive que si l'adresse correspond à un compte existant.",
  "admin.mailtest_dest": "Adresse de destination",
  "admin.mailtest_envoyer": "Envoyer un e-mail test",
  "admin.mailtest_ok": "✅ Demande envoyée pour {email}. Vérifie ta boîte (et les spams). Rien reçu ? Le SMTP de Supabase Auth n'est pas (bien) configuré.",
  ...
  "admin.mailtest_aide_smtp": "configure le SMTP OVH dans Supabase → Authentication → SMTP.",
...
Object.assign(I18N.en, {
  ...
  "admin.mailtest_note": "Sends a password-reset email (same path as confirmation / forgot-password emails) to check that Supabase SMTP works. Only arrives if the address matches an existing account.",
  "admin.mailtest_dest": "Recipient address",
  "admin.mailtest_envoyer": "Send a test email",
  "admin.mailtest_ok": "✅ Request sent for {email}. Check your inbox (and spam). Nothing received? Supabase Auth SMTP isn't (properly) configured.",
  ...
  "admin.mailtest_aide_smtp": "configure OVH SMTP in Supabase → Authentication → SMTP.",
...
Object.assign(I18N.nl, {
  ...
  "admin.mailtest_note": "Stuurt een wachtwoordherstel-e-mail (zelfde weg als bevestigings- / wachtwoord-vergeten-e-mails) om te controleren of de Supabase-SMTP werkt. Komt alleen aan als het adres bij een bestaand account hoort.",
  "admin.mailtest_dest": "Ontvangeradres",
  "admin.mailtest_envoyer": "Test-e-mail versturen",
  "admin.mailtest_ok": "✅ Aanvraag verzonden voor {email}. Controleer je inbox (en spam). Niets ontvangen? Supabase Auth SMTP is niet (juist) ingesteld.",
  ...
  "admin.mailtest_aide_smtp": "stel OVH SMTP in via Supabase → Authentication → SMTP.",
...
Object.assign(I18N.de, {
  ...
  "admin.mailtest_note": "Sendet eine Passwort-Reset-E-Mail (gleicher Weg wie Bestätigungs- / Passwort-vergessen-E-Mails), um zu prüfen, ob das Supabase-SMTP funktioniert. Kommt nur an, wenn die Adresse zu einem bestehenden Konto gehört.",
  "admin.mailtest_dest": "Empfängeradresse",
  "admin.mailtest_envoyer": "Test-E-Mail senden",
  "admin.mailtest_ok": "✅ Anfrage für {email} gesendet. Prüfe dein Postfach (und Spam). Nichts erhalten? Supabase Auth SMTP ist nicht (richtig) konfiguriert.",
  ...
  "admin.mailtest_aide_smtp": "richte OVH SMTP unter Supabase → Authentication → SMTP ein.",
