...
Object.assign(I18N.fr, {
 ...
 "mdj.budget": "⏱️ Conseillé pour cet âge : ~{n} tâches/jour (≈ {min} min d'app, pas plus). Tu peux en cocher plus ou moins.",
  ...
  // La carte d'ami : imprimable, à colorier, à donner à un copain
  "carte.titre": "🖨️ La carte d'ami",
  "carte.bouton": "Imprimer la carte d'ami de {prenom}",
  "carte.mode_emploi": "À imprimer, à colorier, et à donner à un copain. C'est son papa ou sa maman qui scannera le code.",
  "carte.moi": "Moi, c'est {prenom} !",
  "carte.invite": "Viens jouer avec moi sur {app} 🌳",
  "carte.colorier": "✏️ À toi de colorier !",
  "carte.parents_titre": "Pour les parents",
  "carte.parents_texte": "Scannez ce code pour créer votre propre famille sur {app} : gratuit, sans publicité, et vos données restent chez vous.",
  "carte.imprimer": "Imprimer",
...
Object.assign(I18N.en, {
 ...
 "mdj.budget": "⏱️ Recommended for this age: ~{n} tasks/day (≈ {min} min of app, no more). You can tick more or fewer.",
  ...
  "common.fermer": "Close",
  // The friend card: printable, to colour in, to give to a friend
  "carte.titre": "🖨️ The friend card",
  "carte.bouton": "Print {prenom}'s friend card",
  "carte.mode_emploi": "Print it, colour it in, and give it to a friend. Their mum or dad will scan the code.",
  "carte.moi": "I'm {prenom}!",
  "carte.invite": "Come and play with me on {app} 🌳",
  "carte.colorier": "✏️ Your turn to colour!",
  "carte.parents_titre": "For parents",
  "carte.parents_texte": "Scan this code to create your own family on {app}: free, no ads, and your data stays yours.",
  "carte.imprimer": "Print",
...
Object.assign(I18N.nl, {
 ...
 "mdj.budget": "⏱️ Aanbevolen voor deze leeftijd: ~{n} taken/dag (≈ {min} min app, niet meer). Je mag er meer of minder aanvinken.",
  ...
  // De vriendjeskaart: afdrukken, inkleuren, weggeven
  "carte.titre": "🖨️ De vriendjeskaart",
  "carte.bouton": "Vriendjeskaart van {prenom} afdrukken",
  "carte.mode_emploi": "Afdrukken, inkleuren en aan een vriendje geven. Zijn of haar mama of papa scant de code.",
  "carte.moi": "Ik ben {prenom}!",
  "carte.invite": "Kom met mij spelen op {app} 🌳",
  "carte.colorier": "✏️ Nu mag jij kleuren!",
  "carte.parents_titre": "Voor de ouders",
  "carte.parents_texte": "Scan deze code om je eigen familie op {app} aan te maken: gratis, zonder reclame, en je gegevens blijven bij jou.",
  "carte.imprimer": "Afdrukken",
...
Object.assign(I18N.de, {
 ...
 "mdj.budget": "⏱️ Empfohlen für dieses Alter: ~{n} Aufgaben/Tag (≈ {min} Min App, nicht mehr). Du kannst mehr oder weniger ankreuzen.",
  ...
  // Die Freundeskarte: ausdrucken, ausmalen, weitergeben
  "carte.titre": "🖨️ Die Freundeskarte",
  "carte.bouton": "Freundeskarte von {prenom} drucken",
  "carte.mode_emploi": "Ausdrucken, ausmalen und einem Freund geben. Seine Mama oder sein Papa scannt den Code.",
  "carte.moi": "Ich bin {prenom}!",
  "carte.invite": "Komm mit mir auf {app} spielen 🌳",
  "carte.colorier": "✏️ Jetzt darfst du ausmalen!",
  "carte.parents_titre": "Für die Eltern",
  "carte.parents_texte": "Scanne diesen Code, um deine eigene Familie auf {app} zu erstellen: kostenlos, ohne Werbung, und deine Daten bleiben bei dir.",
  "carte.imprimer": "Drucken",
