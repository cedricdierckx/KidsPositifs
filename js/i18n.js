...
Object.assign(I18N.fr, {
 ...
 "mdj.budget": "⏱️ Conseillé pour cet âge : ~{n} tâches/jour (≈ {min} min d'app, pas plus). Tu peux en cocher plus ou moins.",
  ...
  "fam.creer_invitation": "🔗 Créer un lien d'invitation", "fam.changer": "🔁 Changer / créer une famille", "fam.inv_titre": "🔗 Invitations (d'un autre parent)",
  ...
  "admin.nav_stats": "📊 Stats FamiTeam", "admin.nav_familles": "👨‍👩‍👧 Familles", "admin.nav_retours": "💬 Retours", "admin.nav_contenu": "🃏 Contenu", "admin.nav_config": "⚙️ Config", "admin.nav_systeme": "🛠️ Système", "admin.nav_mobile": "📱 Mobile",
  ...
  "admin.ea_oui": "⭐ Early adopter", "admin.ea_non": "☆ Early adopter", "admin.ea_aide": "Early adopter : jamais de proposition de don.", "admin.bloquer": "🚫 Bloquer", "admin.debloquer": "✅ Débloquer", "admin.confirm_bloquer": "Bloquer le compte {email} ? Il ne pourra plus se connecter.", "admin.supprimer": "Supprimer la famille", "admin.confirm_suppr_compte": "Supprimer définitivement la famille « {nom} » et toutes ses données ?", "admin.confirm_suppr_nom": "Pour confirmer, retape le nom exact : {nom}", "admin.nom_incorrect": "Nom incorrect, suppression annulée.", "admin.supprime_ok": "Famille « {nom} » supprimée.", "admin.maj_ok": "Mise à jour effectuée.", "admin.blg_titre": "Blagues du jour", "admin.blg_note": "Une liste par langue. Ajoute ou supprime des blagues : les changements s'appliquent à toute l'app.", "admin.blg_activer": "Afficher la blague du jour sur l'accueil des familles", "admin.blg_desactivees": "Désactivée sur l'accueil pour l'instant (corpus en révision) — tu peux quand même préparer la liste ci-dessous.", "admin.blg_total": "{n} blague(s)", "admin.blg_q": "Question / devinette", "admin.blg_r": "Réponse (avec emoji)", "admin.blg_ajouter": "Ajouter", "admin.blg_ajoutee": "Blague ajoutée 🃏", "admin.blg_confirm_suppr": "Supprimer cette blague ?", "admin.blg_vide": "Remplis la question et la réponse.",
...
Object.assign(I18N.en, {
 ...
 "mdj.budget": "⏱️ Recommended for this age: ~{n} tasks/day (≈ {min} min of app, no more). You can tick more or fewer.",
  ...
  "fam.creer_invitation": "🔗 Create an invite link", "fam.changer": "🔁 Switch / create a family", "fam.inv_titre": "🔗 Invitations (for another parent)",
  ...
  "arbre.code_label": "Your family's referral code",
  ...
  "admin.nav_stats": "📊 Stats FamiTeam", "admin.nav_familles": "👨‍👩‍👧 Families", "admin.nav_retours": "💬 Feedback", "admin.nav_contenu": "🃏 Content", "admin.nav_config": "⚙️ Config", "admin.nav_systeme": "🛠️ System", "admin.nav_mobile": "📱 Mobile",
...
Object.assign(I18N.nl, {
 ...
 "mdj.budget": "⏱️ Aanbevolen voor deze leeftijd: ~{n} taken/dag (≈ {min} min app, niet meer). Je mag er meer of minder aanvinken.",
  ...
  "fam.creer_invitation": "🔗 Uitnodigingslink maken", "fam.changer": "🔁 Familie wisselen / aanmaken", "fam.inv_titre": "🔗 Uitnodigingen (voor een andere ouder)",
  ...
  "dep.promesse": "Twee minuten per dag, als gezin: positief gedrag van kinderen van <strong>3 tot 12 jaar</strong> waarderen, zonder ooit punten af te nemen.",
  ...
  "admin.nav_stats": "📊 Stats FamiTeam", "admin.nav_familles": "👨‍👩‍👧 Families", "admin.nav_retours": "💬 Feedback", "admin.nav_contenu": "🃏 Inhoud", "admin.nav_config": "⚙️ Config", "admin.nav_systeme": "🛠️ Systeem", "admin.nav_mobile": "📱 Mobiel",
  ...
  "admin.ea_oui": "⭐ Early adopter", "admin.ea_non": "☆ Early adopter", "admin.ea_aide": "Early adopter: nooit donaties voorgesteld.", "admin.bloquer": "🚫 Blokkeren", "admin.debloquer": "✅ Deblokkeren", "admin.confirm_bloquer": "Account {email} blokkeren? Kan niet meer inloggen.", "admin.supprimer": "Gezin verwijderen", "admin.confirm_suppr_compte": "Het gezin \u00ab {nom} \u00bb en alle gegevens definitief verwijderen?", "admin.confirm_suppr_nom": "Typ ter bevestiging de exacte naam: {nom}", "admin.nom_incorrect": "Verkeerde naam, verwijdering geannuleerd.", "admin.supprime_ok": "Gezin \u00ab {nom} \u00bb verwijderd.", "admin.maj_ok": "Bijgewerkt.", "admin.blg_titre": "Moppen van de dag", "admin.blg_note": "Eén lijst per taal. Moppen toevoegen of verwijderen: wijzigingen gelden voor de hele app.", "admin.blg_activer": "Mop van de dag tonen op het startscherm van gezinnen", "admin.blg_desactivees": "Momenteel uitgeschakeld op het startscherm (corpus wordt herzien) — je kunt de lijst hieronder alvast voorbereiden.", "admin.blg_total": "{n} mop(pen)", "admin.blg_q": "Vraag / raadsel", "admin.blg_r": "Antwoord (met emoji)", "admin.blg_ajouter": "Toevoegen", "admin.blg_ajoutee": "Mop toegevoegd 🃏", "admin.blg_confirm_suppr": "Deze mop verwijderen?", "admin.blg_vide": "Vul vraag én antwoord in.",
...
Object.assign(I18N.de, {
 ...
 "mdj.budget": "⏱️ Empfohlen für dieses Alter: ~{n} Aufgaben/Tag (≈ {min} Min App, nicht mehr). Du kannst mehr oder weniger ankreuzen.",
  ...
  "fam.creer_invitation": "🔗 Einladungslink erstellen", "fam.changer": "🔁 Familie wechseln / erstellen", "fam.inv_titre": "🔗 Einladungen (für ein weiteres Elternteil)",
  ...
  "cami.bouton": "Freundeskarte von {prenom} drucken oder teilen",
  ...
  "dep.promesse": "Zwei Minuten am Tag, als Familie: positives Verhalten von Kindern von <strong>3 bis 12 Jahren</strong> wertschätzen, ohne jemals Punkte abzuziehen.",
  ...
  "admin.nav_stats": "📊 FamiTeam-Statistik", "admin.nav_familles": "👨‍👩‍👧 Familien", "admin.nav_retours": "💬 Feedback", "admin.nav_contenu": "🃏 Inhalt", "admin.nav_config": "⚙️ Konfig", "admin.nav_systeme": "🛠️ System", "admin.nav_mobile": "📱 Mobil",
...
Object.assign(I18N.en, {
  ...
  "mission.aider_spontane": "Help without being asked", "mission.desaccord": "Settle a disagreement by talking",
  "mission.lave_vaisselle": "Load or empty the dishwasher", "mission.petit_dej": "Make your own breakfast",
  "mission.lire_seul": "Read on your own for a while", "mission.reveil_seul": "Get up on your own",
  "mission.aider_devoirs": "Help a younger one with homework", "mission.repas_simple": "Cook a simple meal",
  "mission.organiser": "Organise a family moment",
  "mission.veille": "Unplug devices left on standby", "mission.saison": "Pick a fruit or vegetable in season",
  "mission.reparer_objet": "Repair instead of replacing", "mission.seconde_main": "Choose second-hand",
...
Object.assign(I18N.nl, {
  ...
  "mission.aider_spontane": "Helpen zonder dat het gevraagd wordt", "mission.desaccord": "Een ruzie uitpraten",
  "mission.lave_vaisselle": "De vaatwasser in- of uitruimen", "mission.petit_dej": "Zelf je ontbijt klaarmaken",
  "mission.lire_seul": "Even alleen lezen", "mission.reveil_seul": "Zelf opstaan",
  "mission.aider_devoirs": "Een jonger kind helpen met huiswerk", "mission.repas_simple": "Een eenvoudige maaltijd koken",
  "mission.organiser": "Een gezinsmoment organiseren",
  "mission.veille": "Apparaten uit de stand-by halen", "mission.saison": "Een fruit of groente van het seizoen kiezen",
  "mission.reparer_objet": "Repareren in plaats van vervangen", "mission.seconde_main": "Tweedehands kiezen",
  "mission.sans_emballage": "Iets kopen zonder verpakking",
...
Object.assign(I18N.de, {
  ...
  "mission.aider_spontane": "Helfen, ohne gefragt zu werden", "mission.desaccord": "Einen Streit im Gespräch klären",
  "mission.lave_vaisselle": "Geschirrspüler ein- oder ausräumen", "mission.petit_dej": "Sein Frühstück selbst machen",
  "mission.lire_seul": "Eine Weile allein lesen", "mission.reveil_seul": "Allein aufstehen",
  "mission.aider_devoirs": "Einem Jüngeren bei den Hausaufgaben helfen", "mission.repas_simple": "Eine einfache Mahlzeit kochen",
  "mission.organiser": "Einen Familienmoment organisieren",
  "mission.veille": "Geräte aus dem Standby nehmen", "mission.saison": "Ein Obst oder Gemüse der Saison wählen",
  "mission.reparer_objet": "Reparieren statt ersetzen", "mission.seconde_main": "Second-Hand wählen",
  "mission.sans_emballage": "Etwas ohne Verpackung kaufen",
...
Object.assign(I18N.fr, {
  ...
  "papier.imprimer": "🖨️ Imprimer la feuille de la semaine",
  "papier.affiche_titre": "L'affiche de la semaine",
  "papier.affiche_note": "Une page par enfant, à coller sur le frigo. On coche au crayon, et l'app relit tout en photo.",
  "papier.atout_ecran": "🌿 Une semaine entière sans écran",
  "papier.atout_frigo": "🧲 Chacun voit où il en est, sans rien demander",
  "papier.atout_photo": "📷 Une photo en fin de semaine, et tout est encodé",
  ...
  "papier.omr_note": "Les petites planètes des bords aident l'app à relire ta feuille en photo : laisse-les tranquilles, et écris seulement dans les cases !",
  ...
  "papier.mode_photo": "Photo (automatique)", "papier.mode_fichier": "Scan (fichier ou PDF)",
  "papier.mode_detaille": "Manuel (case par case)", "papier.mode_express": "Rapide (juste les totaux)",
...
Object.assign(I18N.en, {
  ...
  "papier.imprimer": "🖨️ Print this week's sheet",
  "papier.affiche_titre": "The week's poster",
  "papier.affiche_note": "One page per child, for the fridge door. Tick it by hand, and the app reads it all back from a photo.",
  "papier.atout_ecran": "🌿 A whole week with no screen",
  "papier.atout_frigo": "🧲 Everyone sees where they stand, without asking",
  "papier.atout_photo": "📷 One photo at the end of the week, and it is all entered",
  "papier.encodage_bientot": "💡 Entering the sheet into the app is coming very soon.",
  "papier.semaine_du": "Week of {a} to {b}",
  "papier.feuille_intro": "Tick off every mission you complete! 🌟 At the end of the week, a parent adds it all to the app (just a couple of minutes).",
  "papier.encourage": "Go for it, {prenom} — you've got this week! 💪",
  "papier.bravo": "Great week! Stick your best star here ⭐",
  "papier.omr_note": "The little planets around the edges help the app read your sheet from a photo: leave them alone, and write only inside the boxes!",
  ...
  "papier.mode_photo": "Photo (automatic)", "papier.mode_fichier": "Scan (file or PDF)",
  "papier.mode_detaille": "Manual (box by box)", "papier.mode_express": "Quick (totals only)",
...
Object.assign(I18N.nl, {
  ...
  "papier.imprimer": "🖨️ Het weekblad afdrukken",
  "papier.affiche_titre": "De affiche van de week",
  "papier.affiche_note": "Eén pagina per kind, voor op de koelkast. Met de hand aankruisen, en de app leest alles terug van een foto.",
  "papier.atout_ecran": "🌿 Een hele week zonder scherm",
  "papier.atout_frigo": "🧲 Iedereen ziet waar hij staat, zonder te vragen",
  "papier.atout_photo": "📷 Eén foto op het einde van de week, en alles staat erin",
  "papier.encodage_bientot": "💡 Het invoeren van het blad in de app komt zeer binnenkort.",
  "papier.semaine_du": "Week van {a} tot {b}",
  "papier.feuille_intro": "Vink elke opdracht af die je hebt volbracht! 🌟 Aan het einde van de week voert een ouder alles in de app in (een paar minuutjes).",
  "papier.encourage": "Kom op, {prenom}, deze week ga jij ervoor! 💪",
  "papier.bravo": "Goed gedaan deze week! Plak hier je mooiste ster ⭐",
  "papier.omr_note": "De kleine planeetjes aan de rand helpen de app je blad van een foto te lezen: laat ze met rust en schrijf alleen in de vakjes!",
  ...
  "papier.mode_photo": "Foto (automatisch)", "papier.mode_fichier": "Scan (bestand of PDF)",
  "papier.mode_detaille": "Manueel (vakje per vakje)", "papier.mode_express": "Snel (alleen totalen)",
...
Object.assign(I18N.de, {
  ...
  "papier.imprimer": "🖨️ Das Wochenblatt drucken",
  "papier.affiche_titre": "Das Plakat der Woche",
  "papier.affiche_note": "Eine Seite pro Kind, für den Kühlschrank. Von Hand ankreuzen — die App liest alles von einem Foto zurück.",
  "papier.atout_ecran": "🌿 Eine ganze Woche ohne Bildschirm",
  "papier.atout_frigo": "🧲 Jeder sieht, wo er steht, ohne zu fragen",
  "papier.atout_photo": "📷 Ein Foto am Wochenende, und alles ist eingetragen",
  "papier.encodage_bientot": "💡 Die Eingabe des Blatts in die App kommt sehr bald.",
  "papier.semaine_du": "Woche vom {a} bis {b}",
  "papier.feuille_intro": "Hake jede Aufgabe ab, die du schaffst! 🌟 Am Ende der Woche überträgt ein Elternteil alles in die App (nur ein paar Minuten).",
  "papier.encourage": "Los geht's, {prenom} — diese Woche schaffst du das! 💪",
  "papier.bravo": "Klasse Woche! Klebe hier deinen schönsten Stern ⭐",
  "papier.omr_note": "Die kleinen Planeten am Rand helfen der App, dein Blatt von einem Foto zu lesen: Lass sie in Ruhe und schreibe nur in die Kästchen!",
  ...
  "papier.mode_photo": "Foto (automatisch)", "papier.mode_fichier": "Scan (Datei oder PDF)",
  "papier.mode_detaille": "Manuell (Kästchen für Kästchen)", "papier.mode_express": "Schnell (nur Summen)",
...
Object.assign(I18N.fr, {
  ...
  "timer.mode_permanent": "🔁 Verrouillage permanent (chaque enfant reçoit à nouveau son temps toutes les 6 h, sans PIN)", "timer.mode_permanent_note": "Les compteurs se réinitialisent automatiquement 6 h après que le premier enfant a commencé à jouer. Le parent n'a rien à déverrouiller : il suffit ensuite de choisir qui recommence, sans code PIN.", "timer.mode_off": "🚫 Minuteur désactivé (l'app reste disponible sans limite de temps)", "timer.enregistrer": "✅ Enregistrer", "timer.permanent_active": "Verrouillage permanent activé 🔁", "timer.off_active": "Minuteur désactivé",
...
Object.assign(I18N.de, {
  ...
  "timer.mode_permanent": "🔁 Dauerhafte Sperre (jedes Kind erhält alle 6 Std. seine Zeit zurück, ohne PIN)", "timer.mode_permanent_note": "Die Zähler werden automatisch 6 Std. nachdem das erste Kind zu spielen begonnen hat zurückgesetzt. Die Eltern müssen nichts entsperren: einfach auswählen, wer wieder anfängt, ohne PIN.", "timer.mode_off": "🚫 Timer deaktiviert (die App bleibt ohne Zeitlimit verfügbar)", "timer.enregistrer": "✅ Speichern", "timer.permanent_active": "Dauerhafte Sperre aktiviert 🔁", "timer.off_active": "Timer deaktiviert",
...
Object.assign(I18N.fr, {
  "scan.intro": "Plutôt que de tout recopier : prends la feuille en photo. Elle dit toute seule de quel enfant et de quelle semaine elle est.",
  ...
  "scan.aide": "Pose la feuille à plat, bien éclairée, et cadre toute la grille avec ses quatre petites planètes 🪐. La photo reste sur ton téléphone : rien n'est envoyé.",
  "scan.lecture": "Lecture de la photo…",
  "scan.lu_de": "Feuille de {prenom} : {n} case(s) lue(s) — à vérifier",
  "scan.rien": "Aucune nouvelle case cochée détectée sur cette feuille.",
  "scan.rien_de": "Feuille de {prenom} reconnue, mais aucune nouvelle case cochée.",
  "scan.echec_reperes": "Les quatre petites planètes des coins n'ont pas été trouvées. Reprends la photo bien à plat, avec toute la grille dans le cadre.",
  "scan.echec_feuille": "Cette feuille ne correspond à aucun enfant ni à aucune semaine récente — elle a sans doute été imprimée avant un changement de missions.",
  "scan.echec_ambigu": "Deux feuilles se ressemblent trop pour les départager : rien n'a été lu, plutôt que de risquer le mauvais enfant. Réimprime la feuille et réessaie.",
  "scan.echec_image": "Photo illisible. Réessaie avec une autre prise de vue.",
  "scan.revue_qui": "Feuille de {prenom} · {semaine}",
  "scan.lu_multi": "{f} feuilles reconnues, {n} case(s) lue(s) — à vérifier",
  "scan.revue_lot": "{f} feuilles lues sur {p} page(s) — à vérifier",
  "scan.revue_ailleurs": "Aucune feuille lue pour cet enfant et cette semaine : choisis-en une ci-dessus.",
  "scan.retirer_feuille": "Retirer cette feuille",
  "scan.revue": "{n} case(s) détectée(s).",
  "scan.revue_doutes": "{n} autre(s) restent douteuses (?).",
  "scan.revue_aide": "Touche n'importe quelle case pour la corriger : ✓ pour la garder, vide pour l'écarter. Rien n'est inscrit avant ton « Enregistrer ».",
  "scan.doutes_tous": "✓ Garder les {n} douteuses",
  "scan.doutes_aucun": "Écarter les douteuses",
  "scan.case_aide": "Touche pour corriger cette case",
...
Object.assign(I18N.en, {
  "scan.intro": "Rather than typing it all back in: photograph the sheet. It says by itself which child and which week it belongs to.",
  ...
  "scan.aide": "Lay the sheet flat in good light, and frame the whole grid with its four little planets 🪐. The photo stays on your phone: nothing is sent.",
  "scan.lecture": "Reading the photo…",
  "scan.lu_de": "{prenom}'s sheet: {n} box(es) read — please check",
  "scan.rien": "No newly ticked box found on this sheet.",
  "scan.rien_de": "{prenom}'s sheet recognised, but no newly ticked box.",
  "scan.echec_reperes": "The four corner planets weren't found. Retake the photo flat, with the whole grid in frame.",
  "scan.echec_feuille": "This sheet matches no child and no recent week — it was probably printed before a change in the mission list.",
  "scan.echec_ambigu": "Two sheets look too alike to tell apart: nothing was read, rather than risk the wrong child. Reprint the sheet and try again.",
  "scan.echec_image": "Unreadable photo. Try another shot.",
  "scan.revue_qui": "{prenom}'s sheet · {semaine}",
  "scan.lu_multi": "{f} sheets recognised, {n} box(es) read — please check",
  "scan.revue_lot": "{f} sheets read out of {p} page(s) — please check",
  "scan.revue_ailleurs": "No sheet was read for this child and week: pick one above.",
  "scan.retirer_feuille": "Remove this sheet",
  "scan.revue": "{n} box(es) detected.",
  "scan.revue_doutes": "{n} more remain unclear (?).",
  "scan.revue_aide": "Tap any box to correct it: ✓ to keep it, empty to drop it. Nothing is recorded before you tap Save.",
  "scan.doutes_tous": "✓ Keep the {n} unclear ones",
  "scan.doutes_aucun": "Drop the unclear ones",
  "scan.case_aide": "Tap to correct this box",
...
Object.assign(I18N.nl, {
  "scan.intro": "In plaats van alles over te typen: neem een foto van het blad. Het zegt zelf van welk kind en van welke week het is.",
  ...
  "scan.aide": "Leg het blad plat en goed verlicht, en breng het hele raster met zijn vier kleine planeten 🪐 in beeld. De foto blijft op je telefoon: er wordt niets verstuurd.",
  "scan.lecture": "De foto wordt gelezen…",
  "scan.lu_de": "Blad van {prenom}: {n} vakje(s) gelezen — even nakijken",
  "scan.rien": "Geen nieuw aangekruist vakje gevonden op dit blad.",
  "scan.rien_de": "Blad van {prenom} herkend, maar geen nieuw aangekruist vakje.",
  "scan.echec_reperes": "De vier planeetjes in de hoeken zijn niet gevonden. Maak de foto opnieuw, plat, met het hele raster in beeld.",
  "scan.echec_feuille": "Dit blad hoort bij geen enkel kind en bij geen enkele recente week — het is wellicht afgedrukt vóór een wijziging in de missies.",
  "scan.echec_ambigu": "Twee bladen lijken te veel op elkaar: er is niets gelezen, liever dan het verkeerde kind te riskeren. Druk het blad opnieuw af en probeer opnieuw.",
  "scan.echec_image": "Onleesbare foto. Probeer een andere opname.",
  "scan.revue_qui": "Blad van {prenom} · {semaine}",
  "scan.lu_multi": "{f} bladen herkend, {n} vakje(s) gelezen — even nakijken",
  "scan.revue_lot": "{f} bladen gelezen op {p} pagina('s) — even nakijken",
  "scan.revue_ailleurs": "Voor dit kind en deze week is geen blad gelezen: kies er hierboven een.",
  "scan.retirer_feuille": "Dit blad weglaten",
  "scan.revue": "{n} vakje(s) gevonden.",
  "scan.revue_doutes": "{n} andere blijven twijfelachtig (?).",
  "scan.revue_aide": "Tik op eender welk vakje om het te verbeteren: ✓ om het te houden, leeg om het te laten vallen. Er wordt niets opgeslagen vóór je op Opslaan tikt.",
  "scan.doutes_tous": "✓ De {n} twijfelgevallen houden",
  "scan.doutes_aucun": "Twijfelgevallen laten vallen",
  "scan.case_aide": "Tik om dit vakje te verbeteren",
...
Object.assign(I18N.de, {
  "scan.intro": "Statt alles abzutippen: fotografiere das Blatt. Es sagt von selbst, zu welchem Kind und zu welcher Woche es gehört.",
  ...
  "scan.aide": "Lege das Blatt flach und gut beleuchtet hin und bringe das ganze Raster mit seinen vier kleinen Planeten 🪐 ins Bild. Das Foto bleibt auf deinem Telefon: Es wird nichts gesendet.",
  "scan.lecture": "Das Foto wird gelesen…",
  "scan.lu_de": "Blatt von {prenom}: {n} Kästchen gelesen — bitte prüfen",
  "scan.rien": "Auf diesem Blatt wurde kein neu angekreuztes Kästchen gefunden.",
  "scan.rien_de": "Blatt von {prenom} erkannt, aber kein neu angekreuztes Kästchen.",
  "scan.echec_reperes": "Die vier kleinen Planeten in den Ecken wurden nicht gefunden. Fotografiere erneut, flach, mit dem ganzen Raster im Bild.",
  "scan.echec_feuille": "Dieses Blatt passt zu keinem Kind und zu keiner jüngeren Woche — es wurde wohl vor einer Änderung der Missionen gedruckt.",
  "scan.echec_ambigu": "Zwei Blätter ähneln sich zu sehr: Es wurde nichts gelesen, statt das falsche Kind zu riskieren. Drucke das Blatt neu und versuche es erneut.",
  "scan.echec_image": "Unlesbares Foto. Versuche eine andere Aufnahme.",
  "scan.revue_qui": "Blatt von {prenom} · {semaine}",
  "scan.lu_multi": "{f} Blätter erkannt, {n} Kästchen gelesen — bitte prüfen",
  "scan.revue_lot": "{f} Blätter von {p} Seite(n) gelesen — bitte prüfen",
  "scan.revue_ailleurs": "Für dieses Kind und diese Woche wurde kein Blatt gelesen: wähle oben eines aus.",
  "scan.retirer_feuille": "Dieses Blatt weglassen",
  "scan.revue": "{n} Kästchen erkannt.",
  "scan.revue_doutes": "{n} weitere bleiben unklar (?).",
  "scan.revue_aide": "Tippe ein beliebiges Kästchen an, um es zu korrigieren: ✓ zum Behalten, leer zum Verwerfen. Vor deinem „Speichern“ wird nichts eingetragen.",
  "scan.doutes_tous": "✓ Die {n} unklaren behalten",
  "scan.doutes_aucun": "Unklare verwerfen",
  "scan.case_aide": "Antippen, um dieses Kästchen zu korrigieren",
...
Object.assign(I18N.de, {
  ...
  "regl.enfants_note": "Vorname, Geburtsdatum, Farbe… einmal einstellen, dann selten wieder nötig.",
  "regl.enfants_ouvrir": "👧 „Meine Kinder“ öffnen",
...
Object.assign(I18N.nl, {
  "auth.hero_sous": "Twee minuten per dag, samen: {app} waardeert positief gedrag bij kinderen van 3 tot 12 jaar — en neemt nooit punten af.",
...
Object.assign(I18N.de, {
  "auth.hero_sous": "Zwei Minuten am Tag, gemeinsam: {app} bestärkt positives Verhalten bei Kindern von 3 bis 12 Jahren — und zieht nie Punkte ab.",
...
Object.assign(I18N.fr, {
  ...
  // Même décompte pour un grand : « dodos » ne se dit plus passé 7-8 ans, et
  // c'est aussi la formulation lue par les parents (bloc parents, modale).
