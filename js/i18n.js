...
Object.assign(I18N.fr, {
  ...
  "timer.mode_permanent": "🔁 Verrouillage permanent (chaque enfant reçoit à nouveau son temps toutes les 6 h, sans PIN)", "timer.mode_permanent_note": "Les compteurs se réinitialisent automatiquement toutes les 6 h (0 h, 6 h, 12 h, 18 h). Le parent n'a rien à déverrouiller : l'application se relance toute seule.", "timer.enregistrer": "✅ Enregistrer", "timer.permanent_active": "Verrouillage permanent activé 🔁",
...
Object.assign(I18N.en, {
  ...
  "timer.mode_permanent": "🔁 Permanent lock (each child gets their time back every 6 h, no PIN)", "timer.mode_permanent_note": "Time budgets reset automatically every 6 h (midnight, 6am, noon, 6pm). Nothing for a parent to unlock: the app restarts itself.", "timer.enregistrer": "✅ Save", "timer.permanent_active": "Permanent lock enabled 🔁",
...
Object.assign(I18N.nl, {
  ...
  "timer.mode_permanent": "🔁 Permanente vergrendeling (elk kind krijgt om de 6 u opnieuw zijn tijd, zonder PIN)", "timer.mode_permanent_note": "De tellers worden automatisch elke 6 u gereset (0 u, 6 u, 12 u, 18 u). De ouder hoeft niets te ontgrendelen: de app herstart zichzelf.", "timer.enregistrer": "✅ Opslaan", "timer.permanent_active": "Permanente vergrendeling geactiveerd 🔁",
...
Object.assign(I18N.de, {
  ...
  "timer.mode_permanent": "🔁 Dauerhafte Sperre (jedes Kind erhält alle 6 Std. seine Zeit zurück, ohne PIN)", "timer.mode_permanent_note": "Die Zähler werden automatisch alle 6 Std. zurückgesetzt (0, 6, 12, 18 Uhr). Die Eltern müssen nichts entsperren: Die App startet sich selbst neu.", "timer.enregistrer": "✅ Speichern", "timer.permanent_active": "Dauerhafte Sperre aktiviert 🔁",
