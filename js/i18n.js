...
Object.assign(I18N.fr, {
 ...
 "mdj.budget": "⏱️ Conseillé pour cet âge : ~{n} tâches/jour (≈ {min} min d'app, pas plus). Tu peux en cocher plus ou moins.",
  ...
  "sync.conflit": "⚠️ Une mise à jour a eu lieu sur un autre appareil entretemps. Ouvre l'espace Parents → Récupération pour vérifier les compteurs avant de continuer.",
...
Object.assign(I18N.en, {
 ...
 "mdj.budget": "⏱️ Recommended for this age: ~{n} tasks/day (≈ {min} min of app, no more). You can tick more or fewer.",
  ...
  "sync.conflit": "⚠️ An update happened on another device in the meantime. Open Parents → Recovery to check the counters before continuing.",
...
Object.assign(I18N.nl, {
 ...
 "mdj.budget": "⏱️ Aanbevolen voor deze leeftijd: ~{n} taken/dag (≈ {min} min app, niet meer). Je mag er meer of minder aanvinken.",
  ...
  "sync.conflit": "⚠️ Ondertussen is er op een ander toestel een update gebeurd. Open Ouders → Herstel om de tellers te controleren voor je verdergaat.",
...
Object.assign(I18N.de, {
 ...
 "mdj.budget": "⏱️ Empfohlen für dieses Alter: ~{n} Aufgaben/Tag (≈ {min} Min App, nicht mehr). Du kannst mehr oder weniger ankreuzen.",
  ...
  "sync.conflit": "⚠️ In der Zwischenzeit gab es ein Update auf einem anderen Gerät. Öffne Eltern → Wiederherstellung, um die Zähler zu prüfen, bevor du weitermachst.",
