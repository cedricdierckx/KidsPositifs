/* =====================================================================
 * FamiTeam — Interface : Accès parent et petites fêtes
 * ---------------------------------------------------------------------
 * Le code PIN qui garde l'espace parents (et sa réinitialisation par
 * e-mail), plus les deux animations de félicitations : un badge décroché,
 * un parrainage abouti. C'est la première chose que voit un parent qui
 * veut passer « de l'autre côté » — d'où sa place en tête.
 *
