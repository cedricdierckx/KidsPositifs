/* =====================================================================
 * FamiTeam — Interface : Arbre des familles, dépliant, carte d'ami
 * ---------------------------------------------------------------------
 * Tout ce qui sert à faire connaître FamiTeam à une autre famille :
 * l'arbre qui se garnit d'une feuille par famille amenée, le dépliant
 * imprimable pour une école, la carte d'ami que l'enfant colorie, et la
 * modale qui donne le code permanent de la famille avec son QR.
 * Voir PLAN-PARRAINAGE.md.
 *
