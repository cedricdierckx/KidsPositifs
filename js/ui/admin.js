/* =====================================================================
 * FamiTeam — Espace administrateur : contenu, familles, statistiques, retours, système
 * ---------------------------------------------------------------------
 * Morceau de l'ancien js/ui.js (Phase C, découpage en sous-vues).
 * L'espace réservé à l'administrateur, hors page Croissance : blagues,
 * tableau de bord scientifique, familles, envoi de test, dons, pistes mobiles,
 * statistiques, retours des familles et informations système.
 *
