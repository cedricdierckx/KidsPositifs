/* =====================================================================
 * FamiTeam — Interface : Admin → Croissance (plan de développement)
 * ---------------------------------------------------------------------
 * L'avancement du plan commercial, les e-mails types, les envois
 * automatiques, le coût annuel et les décisions en attente. Les DONNÉES
 * du plan vivent dans js/croissance.js et PLAN-COMMERCIAL.md ; ici,
 * seulement leur mise en écran.
 *
