/* =====================================================================
 * FamiTeam — Interface : Minuteur d'écran et verrouillages
 * ---------------------------------------------------------------------
 * L'affichage du temps restant, l'écran « qui commence ? », le verrou par
 * code PIN et le verrou permanent (cycle de 6 h, sans PIN). La logique
 * elle-même vit dans js/app.js : ici, seulement ce qui se voit.
 *
