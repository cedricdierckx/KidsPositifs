/* =====================================================================
 * FamiTeam — Squelette de l'app, navigation, gestes, tutoriel
 * ---------------------------------------------------------------------
 * Morceau de l'ancien js/ui.js (Phase C, découpage en sous-vues).
 * Le cadre dans lequel toutes les vues se peignent : barre du bas, en-tête,
 * changement d'enfant (boutons et balayage), blocs pliables, sélecteur de
 * langue et tutoriel de première ouverture.
 *
