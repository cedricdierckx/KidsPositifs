/* =====================================================================
 * FamiTeam — Interface : Feuille papier de la semaine
 * ---------------------------------------------------------------------
 * Encoder une semaine d'un coup, et l'imprimer : une page par enfant, à
 * afficher sur le frigo. Le seul écran de FamiTeam pensé pour finir sur
 * du papier plutôt que sur un écran.
 *
